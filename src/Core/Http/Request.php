...
class Request implements RequestInterface
{
    ...
    {
        return !isset($key) ? $this->query : ($this->query[$key] ?? null);
    }
    ...
    {
        return !isset($key) ? $this->body : ($this->body[$key] ?? null);
    }
    ...
    {
        return !isset($key) ? $this->files : ($this->files[$key] ?? null);
    }
    ...
    {
        return !isset($key) ? $this->cookies : ($this->cookies[$key] ?? null);
    }
    ...
    {
        return !isset($key) ? $this->headers : ($this->headers[$key] ?? null);
    }
