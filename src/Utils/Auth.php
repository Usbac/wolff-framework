...
final class Auth extends \Wolff\Core\DB
{
    ...
    /**
     * The last currently authenticated user's data
     *
     * @var array
     */
    ...
    /**
     * Initializes the database connection for the authentication utility
     *
    ...
    /**
     * Sets the unique column that cannot be repeated
     *
